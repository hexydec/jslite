 ...
 */
class MatthiasMullieTest extends \PHPUnit\Framework\TestCase {

	public function testMatthiasMullie() {
		if (($tests = $this->getTests()) !== null) {
			$obj = new jslite();
    ...
    protected function getTests() {
        $tests = array();
		$dir = 'https://raw.githubusercontent.com/matthiasmullie/minify/master/tests/js';

        // adding multiple files
        // $tests[] = array(
        //     array(
        //         $dir.'/sample/source/script1.js',
        //         $dir.'/sample/source/script2.js',
        //     ),
